...
//           var toPay = summaryPanel.children[3].firstElementChild;
//           toPay.innerText=sum;
//         })
//       }
//    })
//  }
 ...
 // var toPickUp = document.querySelectorAll(".form div");
 // var form = document.querySelector(".form");
 // var summaryPanel = document.querySelector(".summary_panel");
 //
 //
 // var titlePrice = document.querySelectorAll(".form .drop_down_list .list_panel li")
 //
 // for (var i = 0; i < toPickUp.length; i++) {
 //    toPickUp[i].addEventListener("click", function(e){
 //      this.children[2].style.display = "block";
 //
 //      var choice = this.children[2].querySelectorAll("li");
 //
 //      for (var j = 0; j < choice.length; j++) {
 //         choice[j].addEventListener("click", function(e){
 //           var selected = this.innerText;
